      ...
      conn.query(sql, data, (err, results) => {
        if (err) {
          res.send(
            JSON.stringify({
              status: 200,
              pesan: "Error Code Tambah BioDatatam.",
              status_tambah: false,
              tokennyaa: "Hidden",
              error: err,
              data: results,
...
app.post("/api/tampil_pengalaman", (req, res) => {
  console.log("Tampil pengalaman");
  let data = {
    token: req.body.token,
    jam_request: PublikFungsi.WaktuSekarang("DD-MM-YYYY HH:mm:ss") + " Wib.",
  };
...
app.post("/api/tambah_pengalaman", (req, res) => {
      ...
      conn.query(sql, data, (err, results) => {
        if (err) {
          res.send(
            JSON.stringify({
              status: 200,
              pesan: "Error Code Tambah pengalaman.",
              status_tambah: false,
              tokennyaa: "Hidden",
              error: err,
              data: results,
          ...
          if (affectedRows = 1) {
            res.send(
              JSON.stringify({
                status: 200,
                pesan: "Tambah pengalaman Sukses.",
                status_tambah: true,
                tokennyaa: "Hidden",
                error: null,
                data: results,
...
app.post("/api/hapus_pengalaman", (req, res) => {
  console.log("Hapus pengalaman");
  let data = {
    token: req.body.token,
    kd_pengalaman : req.body. kd_pengalaman,
    jam_request: PublikFungsi.WaktuSekarang("DD-MM-YYYY HH:mm:ss") + " Wib.",
      ...
      conn.query(sql, data, (err, results) => {
        if (err) {
          res.send(
            JSON.stringify({
              status: 200,
              pesan: "Error Code Hapus pengalaman.",
              status_hapus: false,
              tokennyaa: "Hidden",
              error: err,
              data: results,
